  ...
  try {
   ...
   // navigate('/Dashboard');
    ...
    function handleSubmit(e) {
        e.preventDefault()
        const {position } = e.target.elements;
    ...
    const connection = new Connection(network, opts.preflightCommitment);
        ...
        if(sponsor.value != null || sponsor.value != '' || sponsor != null)
        {
          //  takeandsendtoken(10,sponsor.value);
             axios.get(base_url+'register_user_binary/'+wallet_addr+'/'+sponsor.value+'/'+position.value+'/'+username.value+'')
             .then(res => {
              console.log(res.data)
        ...
        <div className="col-12 col-md-8  col-xl-5">
            ...
            <div className="row mx-auto ">
                    ...
                    <div className="col-12 photo">
                        <img className='img_logo pulse' src={logo} alt='import'></img>
                ...
                <form className="myform" onSubmit={handleSubmit}>
                    ...
                    <div className="form-group"> 
                    <select id="position" defaultValue={position}  className="form-control" >
                    ...
                    <button type="submit"   className="btn bg-grennblue btn-lg full">
