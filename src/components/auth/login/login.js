  ...
  return (
    ...
    <div className="row d-flex justify-content-center mt20">
        <div className="col-12 col-md-8  col-xl-5">
            <div className="background_theme login_card py-3 px-2 shadow p-3 mb-5">
            <div className="row mx-auto">
                ...
                {!wallet.connected
                ?
                <WalletMultiButton className="btn bg-grennblue  btn-lg full" />
                
                :<button type="button" onClick={login_user_with_wallet}   className="btn bg-grennblue btn-lg full">
